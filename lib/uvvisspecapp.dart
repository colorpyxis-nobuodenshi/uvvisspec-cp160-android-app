...
class ResultConverter {
  ...
  Future<HashMap<FilterSpectralIntensityType, List<double>>> _readIncectsSpectralIntensity() async {
    final loadedData = await rootBundle.loadString('assets/filterspectralintensity.csv');
    var isil1 = <double>[];
    var isil2 = <double>[];
    var isil3 = <double>[];
    var isil4 = <double>[];
  ...
  Future<ResultReport> convert(UVVisSpecDeviceResult uvsr, Settings settings) async {
