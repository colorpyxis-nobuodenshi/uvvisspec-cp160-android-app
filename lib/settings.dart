            ...
            children: [
              ...
              Card(
                ...
                children: <Widget>[
                  ...
                  // RadioListTile(title: const Text("クロロフィルA"), value: InsectsSpectralIntensityType.GaC, groupValue: _typeSel, onChanged: (value) => { setState(()=>{_typeSel = InsectsSpectralIntensityType.GaC })}),
                  // RadioListTile(title: const Text("クロロフィルB"), value: InsectsSpectralIntensityType.GaC, groupValue: _typeSel, onChanged: (value) => { setState(()=>{_typeSel = InsectsSpectralIntensityType.GaC })}),
                  RadioListTile(title: const Text("照度（視感度）"), value: InsectsSpectralIntensityType.GaC, groupValue: _typeSel, onChanged: (value) => { setState(()=>{_typeSel = InsectsSpectralIntensityType.GaC })}),
                ],
              ),
              ),
              Card(
